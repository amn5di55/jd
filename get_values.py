...
def get_required_values():
    # 第一步：获取页面配置
    config_url = "https://gw2c-hw-open.longfor.com/supera/member/api/bff/pages/v1_10_0/publicApi/v1/pageConfig"
    config_payload = {"pageCode": "L0mine"}
    config_headers = {
        'User-Agent': "com.longfor.supera/1.10.2 iOS/17.0.2",
        'Content-Type': "application/json",
        'X-LF-Api-Version': "v1_10_0",
        'X-LF-Bucode': "L00602"
    }
